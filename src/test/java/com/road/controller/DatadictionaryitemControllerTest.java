...
class DatadictionaryitemControllerTest {
    ...
    void touch() throws Exception {
        ...
        String[] sps = {"id","dlm","ssdd","sszd","dlsx","dlfldj","cd","hdmkd","hdmkdbz","hdmjg","hdmjgbz","cdfb","cdfbbz","sjsd","fx","qd","zd","xhdlkcount","fdkzxlcount","lnbwcount","glsscount","gjzdcou","rxhdxcount","jzwcrkcount","bzpcount","dlqcount","jszcoun","jshcdcount","tqlbcount","bsdcoun","isglsscount","lsydbzcount","qtjtsscou","xzsj","xgsj","scsj","isdel","blr","ip"};
