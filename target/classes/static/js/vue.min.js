var Vue = (function (exports) {
    ...
    function setDevtoolsHook(hook, target) {
        ...
        if (exports.devtools) {
            ...
            // browser environment to avoid the timer handle stalling com.test runner exit
            // (#4815)
     ...
     * used for creating stubs in the com.test-utils
     * It is *internal* but needs to be exposed for com.test-utils to pick up proper
     * typings
     */
    ...
    function createSetupContext(instance) {
        ...
        let attrs;
        {
            // We use getters in dev in case libs like com.test-utils overwrite instance
